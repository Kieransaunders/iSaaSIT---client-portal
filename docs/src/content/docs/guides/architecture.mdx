---
title: Architecture
description: Understanding the iSaaSIT architecture and data model
---

iSaaSIT follows a multi-tenant architecture designed for agencies managing multiple client companies.
